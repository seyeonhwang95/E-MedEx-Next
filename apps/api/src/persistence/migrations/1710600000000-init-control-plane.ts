...
export class InitControlPlane1710600000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE UNIQUE INDEX IF NOT EXISTS ux_tenant_labs_tenant_lab ON tenant_labs (tenant_id, lab_code)',
    );
