...
export class ControlPlaneOfflineGrants1710600005000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE INDEX IF NOT EXISTS ix_offline_device_grants_tenant_user_device ON offline_device_grants (tenant_id, user_id, device_id)',
    );
  }
