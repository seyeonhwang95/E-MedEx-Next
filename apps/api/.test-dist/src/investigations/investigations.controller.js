...
let InvestigationsController = class InvestigationsController {
    ...
    getInvestigationByCaseId(request, caseId) {
        return this.investigationsService.getInvestigationByCaseId(request, caseId);
    }
    upsertInvestigation(request, caseId, payload) {
...
], InvestigationsController.prototype, "getInvestigationByCaseId", null);
__decorate([
    Put(':caseId'),
    Roles(roles.Investigator),
    __param(0, Req()),
    ...
    __param(2, Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, UpsertInvestigationDto]),
    __metadata("design:returntype", void 0)
], InvestigationsController.prototype, "upsertInvestigation", null);
InvestigationsController = __decorate([
    Controller('investigations'),
    __param(0, Inject(InvestigationsService)),
    __metadata("design:paramtypes", [InvestigationsService])
], InvestigationsController);
export { InvestigationsController };
