...
let TenantResolutionMiddleware = class TenantResolutionMiddleware {
    ...
    constructor(tenantRegistryService) {
    ...
    async use(req, _res, next) {
        ...
        const tenantAwareRequest = req;
        tenantAwareRequest.tenant = tenant;
        req.headers['x-tenant-id'] = tenant.tenantId;
        next();
    }
};
TenantResolutionMiddleware = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [TenantRegistryService])
], TenantResolutionMiddleware);
export { TenantResolutionMiddleware };
