...
], ValidateOfflineGrantDto.prototype, "grantId", void 0);
__decorate([
    ApiProperty({ example: 'demo', description: 'Tenant ID' }),
    IsString(),
    MaxLength(64),
    __metadata("design:type", String)
], ValidateOfflineGrantDto.prototype, "tenantId", void 0);
__decorate([
    ApiProperty({ example: 'field-user-1', description: 'User/field staff ID' }),
    IsString(),
    MaxLength(128),
    __metadata("design:type", String)
], ValidateOfflineGrantDto.prototype, "userId", void 0);
__decorate([
    ApiProperty({ example: 'device-1', description: 'Device identifier' }),
    IsString(),
    MaxLength(128),
    __metadata("design:type", String)
], ValidateOfflineGrantDto.prototype, "deviceId", void 0);
__decorate([
    IsOptional(),
    IsString(),
    MaxLength(64),
    __metadata("design:type", String)
], ValidateOfflineGrantDto.prototype, "scope", void 0);
